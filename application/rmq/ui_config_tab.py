...
class RMQConfigTab(BaseConfigTab):
    ...
    def create_tab_content(self):
        ...
        # 队列名称
        ttk.Label(frame, text="队列名称:").grid(row=1, column=0, padx=5, pady=5, sticky="e")
        queue_entry = ttk.Entry(frame, textvariable=self.config_vars["queue"])
        queue_entry.grid(row=1, column=1, padx=5, pady=5, sticky="ew")
