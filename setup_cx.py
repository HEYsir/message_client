...
include_files = []
# include_files = ["application", "core", "ui", "protocol"]
...
build_exe_options = {
    "packages": [
        ...
        "application.rmq.service",
        "protocol",
    ],
    "includes": [
        # 强制包含所有动态发现的tab页面及其父包
        "application.http.ui_config_tab",
        "application.kafka.ui_config_tab",
        "application.rmq.ui_config_tab",
        "application.http",
        "application.kafka",
        "application.rmq",
        "ui.base_tab",
